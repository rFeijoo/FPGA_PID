...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {duty[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {duty[0]}]
set_property PACKAGE_PIN E19 [get_ports {duty[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {duty[1]}]
set_property PACKAGE_PIN U19 [get_ports {duty[2]}]					
...
set_property PACKAGE_PIN W18 [get_ports {pwm_led}]					
...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {rx_pin}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rx_pin}]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {start}]					
