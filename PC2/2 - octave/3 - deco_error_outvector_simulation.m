...
lookup = textread('error_bin.txt', '%s');
result = textread('out_vector_error.txt', '%s');
...
xlabel("Amostras");
ylabel("Erro");
title("Comparacao Hw Vs. Sw [32 bits Vs. 64 bits] - Simulacao Erro PID");
annotation ("textbox", [.25 .75 .5 .09], "string", mySTR, "horizontalalignment", "center", "fitboxtotext", "off");
hold on;
print('Hardware_VS_Software - Error Simulation.png','-dpng');